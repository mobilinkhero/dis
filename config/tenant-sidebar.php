        ...
        'ecommerce_section' => [
            ...
            'children' => [
                ...
                'ai_dashboard' => [
                    ...
                    'route' => 'tenant.ai.dashboard',
                    'icon' => 'heroicon-o-chart-pie',
                    'permission' => 'tenant.ecommerce.view',
                    'order' => 5,
                    'active_routes' => ['tenant.ai.dashboard'],
                ],
                'visual_search' => [
                    'type' => 'item',
                    'label' => 'AI Visual Search',
                    'route' => 'tenant.visual.search',
                    'icon' => 'heroicon-o-magnifying-glass',
                    'permission' => 'tenant.ecommerce.view',
                    'order' => 6,
                    'active_routes' => ['tenant.visual.search'],
                ],
                'ar_tryout' => [
                    'type' => 'item',
                    'label' => 'AR Virtual Try-On',
                    'route' => 'tenant.ar.tryout',
                    'icon' => 'heroicon-o-camera',
                    'permission' => 'tenant.ecommerce.view',
                    'order' => 7,
                    'active_routes' => ['tenant.ar.tryout'],
                ],
                'settings' => [
                    'type' => 'item',
                    'label' => 'settings',
