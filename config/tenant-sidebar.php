        ...
        'ecommerce_section' => [
            ...
            'children' => [
                ...
                'products' => [
                    'type' => 'item',
                    'label' => 'products',
                    'route' => 'tenant.ecommerce.products',
                ...
                'ai_dashboard' => [
                    ...
                    'route' => 'tenant.ecommerce.ai-dashboard',
                    'icon' => 'heroicon-o-chart-pie',
                    'permission' => 'tenant.ecommerce.view',
                    'order' => 5,
                    'active_routes' => ['tenant.ecommerce.ai-dashboard'],
                ],
                'visual_search' => [
                    'type' => 'item',
                    'label' => 'AI Visual Search',
                    'route' => 'tenant.ecommerce.visual-search',
                    'icon' => 'heroicon-o-magnifying-glass',
                    'permission' => 'tenant.ecommerce.view',
                    'order' => 6,
                    'active_routes' => ['tenant.ecommerce.visual-search'],
                ],
                'ar_tryout' => [
                    'type' => 'item',
                    'label' => 'AR Virtual Try-On',
                    'route' => 'tenant.ecommerce.ar-tryout',
                    'icon' => 'heroicon-o-camera',
                    'permission' => 'tenant.ecommerce.view',
                    'order' => 7,
                    'active_routes' => ['tenant.ecommerce.ar-tryout'],
                ],
                'settings' => [
                    'type' => 'item',
                    'label' => 'settings',
