...
return [
    'main_menu' => [
        ...
        'ecommerce_section' => [
            ...
            'label' => 'ecommerce',
            'icon' => null,
            'permission' => ['tenant.ecommerce.view', 'tenant.products.view', 'tenant.orders.view'],
            'permission_type' => 'any',
            'order' => 8,
            'section_id' => 'ecommerce',
            'feature_required' => 'ecommerce_bot',
            'children' => [
                'ecommerce_dashboard' => [
                    'type' => 'item',
                    'label' => 'ecommerce_dashboard',
                    'route' => 'tenant.ecommerce.dashboard',
                    'icon' => 'heroicon-o-squares-2x2',
                    'permission' => 'tenant.ecommerce.view',
                    'order' => 1,
                    'active_routes' => ['tenant.ecommerce.dashboard'],
                    'feature_required' => 'ecommerce_bot',
                ],
                'ecommerce_setup' => [
                    'type' => 'item',
                    'label' => 'ecommerce_setup',
                    'route' => 'tenant.ecommerce.setup',
                    'icon' => 'heroicon-o-cog-6-tooth',
                    'permission' => 'tenant.ecommerce.setup',
                    'order' => 2,
                    'active_routes' => ['tenant.ecommerce.setup'],
                    'feature_required' => 'ecommerce_bot',
                ],
                'product_management' => [
                    'type' => 'item',
                    'label' => 'product_management',
                    'route' => 'tenant.products.list',
                    'icon' => 'heroicon-o-cube',
                    'permission' => 'tenant.products.view',
                    'order' => 3,
                    'active_routes' => ['tenant.products.*'],
                    'feature_required' => 'ecommerce_bot',
                ],
                'order_management' => [
                    'type' => 'item',
                    'label' => 'order_management',
                    'route' => 'tenant.orders.list',
                    'icon' => 'heroicon-o-clipboard-document-list',
                    'permission' => 'tenant.orders.view',
                    'order' => 4,
                    'active_routes' => ['tenant.orders.*'],
                    'feature_required' => 'ecommerce_bot',
                ],
                'upselling_campaigns' => [
                    'type' => 'item',
                    'label' => 'upselling_campaigns',
                    'route' => 'tenant.ecommerce.upselling',
                    'icon' => 'heroicon-o-arrow-trending-up',
                    'permission' => 'tenant.ecommerce.upselling',
                    'order' => 5,
                    'active_routes' => ['tenant.ecommerce.upselling'],
                    'feature_required' => 'ecommerce_bot',
                ],
                'sales_analytics' => [
                    'type' => 'item',
                    ...
                    'permission' => 'tenant.ecommerce.analytics',
                    'order' => 6,
